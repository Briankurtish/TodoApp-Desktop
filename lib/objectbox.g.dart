...
final _entities = <ModelEntity>[
  ModelEntity(
      id: const IdUid(2, 475164494998298346),
      name: 'TaskModel',
      lastPropertyId: const IdUid(5, 6159275223438398546),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 3138698073680231643),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 2849179016297836721),
            name: 'task_title',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 271611456613048560),
            name: 'task_description',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(4, 4077353580382781469),
            name: 'task_done',
            type: 1,
            flags: 0),
        ModelProperty(
            id: const IdUid(5, 6159275223438398546),
            name: 'creation_date',
            type: 10,
            flags: 0)
      ],
...
ModelDefinition getObjectBoxModel() {
  final model = ModelInfo(
      entities: _entities,
      lastEntityId: const IdUid(2, 475164494998298346),
      lastIndexId: const IdUid(0, 0),
      lastRelationId: const IdUid(0, 0),
      lastSequenceId: const IdUid(0, 0),
      retiredEntityUids: const [801328613961975047],
